...
@author: Sergi Toda <sergi.toda@urv.cat>
'''
import pika
import uuid
import json
...
class Client(object):
    ...
    def __init__(self, env):
        ...
        self.reply_queue = env.get('reply_queue', 'asdf') 
    ...
    def sync_call(self, uid, method, params):
        ...
        props = pika.BasicProperties(app_id=uid, correlation_id=self.corr_id, reply_to=self.reply_queue, type='gson')
